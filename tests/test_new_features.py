...
def test_svg_no_size_attribute():
...
def test_image_cache_mb_parameter():
    ...
    assert len(r.render("<p>test</p>")) > 0


# ── shrink_to_fit ──────────────────────────────────────────────────────────────

def test_shrink_to_fit_narrow_content():
...
def test_shrink_to_fit_wide_content():
...
def test_shrink_to_fit_false_keeps_viewport_width():
    r = Renderer(width=800)
